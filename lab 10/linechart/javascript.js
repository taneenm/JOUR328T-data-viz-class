...
var myChart = new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Life expectancy over time in countries with the highest populations',
                font: {
                    size: 18
                }
            },
            subtitle: {
                display: true,
                text: 'Since 1800, the U.S. has had the highest left expectancy. Brazil, China and Indonesia had close life expectancies until 1950.'
            }
        },
        scales: {
            y: {
